...
namespace HashBasedSearch.Tests.DictionaryWithComparerTests;

[TestClass]
public class DictionaryWithComparerTest
{
    [TestMethod]
    public void ClassWithNoDefaultTest_Existing()
    {
        ...
        var comparer = new TestComplexClassKeyComparer();
        var existingDictionary = testData.ToDictionary(keySelector: testClass => testClass.Key, comparer);

        HashBasedSearchCallback<TestComplexClassKey, TestComplexClass?> searchCallback =
            existingDictionary.BuildHashBasedSearchCallback(comparer);
    ...
    public void ClassWithDefaultTest_Existing()
    {
        ...
        HashBasedSearchCallback<TestComplexClassKey, TestComplexClass?> searchCallback =
            existingDictionary.BuildHashBasedSearchCallback(
                comparer,
